function makeCard(data){
	...
	let profilePhoto = document.querySelector(".prophilePhoto");
	...
	let _location    = document.querySelector(".location p");
	...
	data.location   == null ? document.querySelector(".location").innerHTML = "" : _location.innerHTML = data.location;
...
function changeBackground(){
	...
	document.getElementsByClassName("quadro")[0].style.backgroundColor = `rgb(${rgb[0]},${rgb[1]}, ${rgb[2]})`
}
